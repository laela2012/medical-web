    ...
    const settings = {
        ...
        responsive: [
            ...
            },
            {
                breakpoint: 480,
                settings: {
                    slidesToShow:1, slidesToScroll:1, initialSlide:2,
                },
            },
        ],
      };
    ...
    <div className='min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-16'>
        <div className='flex flex-col items-center lg:flex-row justify-between mb-10 lg:mb-0'>
            <div>
                ...
                <p className='mt-2 text-center lg:text-start'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe, illum.</p>
            </div>
