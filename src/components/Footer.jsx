    ...
    <div className='bg-backgroundColor text-white rounded-t-3xl mt-8 md:mt-0'>
        <div className='flex flex-col md:flex-row justify-between p-8 md:px-32 px-5'>
            <div className='w-full md:w-1/4'>
                <h1 className='font-semibold text-2xl pb-4'>WellnessVista.</h1>
                <p className='text-sm'>Our team of dedicated doctors, each specializing in unique fields such as orthopedics, cardiology, pediatrics, neurology, dermatology, and more.</p>
            </div>
            <div>
                ...
                <nav className='flex flex-col gap-2'>
                    ...
                    <Link to='doctors' spy={true} smooth={true} duration={500} className='hover:text-hoverColor cursor-pointer'>Services</Link>
                    <Link to='doctors' spy={true} smooth={true} duration={500} className='hover:text-hoverColor cursor-pointer'>Doctors</Link>
            ...
            <div>
                ...
                <Link to='services' spy={true} smooth={true} duration={500} className='hover:text-hoverColor transition-all cursor-pointer'>Heart Check</Link>
        ...
        <div>
            <p className='text-center py-4'>@Copyright Developed by: 
                <span className='text-hoverColor'> Laela L </span> | All right reserved
            </p>
        </div>
    </div>
  )
